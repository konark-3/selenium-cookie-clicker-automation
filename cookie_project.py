...
#         shipment_price_str = shipment_text.split()[2].split(",")[0]+shipment_text.split()[2].split(",")[1]
...
#         alchemy_lab_price_str = alchemy_lab_text.split()[3].split(",")[0]+alchemy_lab_text.split()[3].split(",")[1]
...
#         portal_price_str = portal_text.split()[2].split(",")[0]+portal_text.split()[2].split(",")[1]+portal_text.split()[2].split(",")[2]
...
#         time_machine_price_str = time_machine_text.split()[3].split(",")[0]+time_machine_text.split()[3].split(",")[1]+time_machine_text.split()[3].split(",")[2]
